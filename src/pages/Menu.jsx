...
const Menu = () => {
  ...
  const items = [
    { icon: <i className="fa-solid fa-calendar-xmark text-3xl"></i>, label: "NoWork", link: "/admin/non-working-days" },
    { icon: <i className="fa-solid fa-clock text-3xl"></i>, label: "Horarios", link: "/admin/work-hours" },
    { icon: <i className="fa-solid fa-scissors text-3xl"></i>, label: "Servicios", link: "/admin/services" },
    { icon: <i className="fa-solid fa-user-group text-3xl"></i>, label: "Clientes", link: "/admin/clients" },
    { icon: <i className="fa-solid fa-calendar-day text-3xl"></i>, label: "Home", link: "/admin" },
  ...
  return (
    <nav className="fixed z-40  right-14 bottom-14 flex justify-center shadow-xl items-center">
      ...
      <label
        htmlFor="menu-open"
        id="menu-open-button"
        className={`cursor-pointer absolute  bg-primary  w-16 h-16 bg-gray-100 rounded-full flex justify-center items-center transition-all duration-500 transform ${isOpen ? 'scale-50 bg-white' : 'shadow-md shadow-gray '}  z-50 `}
      >
        ...
        {items.map((item, index) => {
          ...
          return (
            <Link
              ...
              className={`absolute   rounded-full w-14 h-14 flex flex-col justify-center  text-white  items-center transition-all duration-300 z-40`}
              style={{
